...
async function requestCoins() {
    ...
    // exchangeRate.src = `${logoData.logo}`

    // console.log(coinData[1].id)
    ...
    let threePrice = Intl.NumberFormat('en-GB', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(coinData[3].price_usd * myRate)
    ...
    let threeMarkCap = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[3].market_cap_usd * myRate)
    let threeVolume = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[3].volume_24h_usd * myRate)
    ...
    let fourPrice = Intl.NumberFormat('en-GB', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(coinData[4].price_usd * myRate)
    ...
    let fourMarkCap = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[4].market_cap_usd * myRate)
    let fourVolume = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[4].volume_24h_usd * myRate)
    ...
    let fivePrice = Intl.NumberFormat('en-GB', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(coinData[5].price_usd * myRate)
    ...
    let fiveMarkCap = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[5].market_cap_usd * myRate)
    let fiveVolume = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[5].volume_24h_usd * myRate)
    ...
    let sixPrice = Intl.NumberFormat('en-GB', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(coinData[6].price_usd * myRate)
    ...
    let sixMarkCap = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[6].market_cap_usd * myRate)
    let sixVolume = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[6].volume_24h_usd * myRate)
    ...
    let sevenPrice = Intl.NumberFormat('en-GB', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(coinData[7].price_usd * myRate)
    ...
    let sevenMarkCap = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[7].market_cap_usd * myRate)
    let sevenVolume = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[7].volume_24h_usd * myRate)
    ...
    let eightPrice = Intl.NumberFormat('en-GB', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(coinData[8].price_usd * myRate)
    ...
    let eightMarkCap = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[8].market_cap_usd * myRate)
    let eightVolume = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[8].volume_24h_usd * myRate)
    ...
    let ninePrice = Intl.NumberFormat('en-GB', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(coinData[9].price_usd * myRate)
    ...
    let nineMarkCap = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[9].market_cap_usd * myRate)
    let nineVolume = Intl.NumberFormat('en-GB', { maximumFractionDigits: 0 }).format(coinData[9].volume_24h_usd * myRate)
